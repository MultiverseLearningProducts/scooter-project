...
describe('Scooter App Class', () => {
    ...
    test('removeScooter method is scooter app class', () => {
        const removeScooter = scooterApp1.removeScooter(scooterApp1.stations['Brooklyn']);
        expect(scooterApp1.stations['Brooklyn']).toEqual([]);
    });
});